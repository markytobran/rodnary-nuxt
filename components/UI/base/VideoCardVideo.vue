<template>
  <div v-if="!showYoutubeVideo" :class="`${height} w-full rounded-lg relative z-40 overflow-hidden cursor-pointer`" @click="togglePictureToIframe">
    <img :src="url" loading="lazy" draggable="false" alt="Video cover image" class="w-full h-full" />
    <span
  ...
  <iframe
    v-else
    :class="`${height} w-full rounded-lg relative z-40`"
