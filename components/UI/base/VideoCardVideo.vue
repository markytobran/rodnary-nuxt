<template>
  <NuxtLink :to="to" :class="`${height} w-full rounded-lg relative z-40 overflow-hidden cursor-pointer`">
    <img :src="url" loading="lazy" draggable="false" alt="Video cover image" :class="height" />
    <span
