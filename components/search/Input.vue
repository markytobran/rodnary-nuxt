<template>
  <form class="flex mx-auto w-1/2" @submit.submit="searchSubmit">
    <div class="relative w-full">
      ...
      />
      <button v-if="showDeleteBtn" class="absolute top-1/2 right-6 -translate-y-1/2 text-white text-2xl" @click="resetInputField">X</button>
    </div>
    <button class="w-24 bg-secondary-color flex justify-center items-center border-2 rounded-r-full" type="submit">
